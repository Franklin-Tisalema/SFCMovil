...
public class FingerprintActivity extends AppCompatActivity {
    ...
    private static final String KEY_NAME = "SFCMovilHuella";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if(datos!=null)
        {
            ...
            datosComunes = new Utilitarios.DatosComunes(distriModel.getUsuario(),distriModel.getFecha(),distriModel.getLocal(),
                    distriModel.getLinea(),impresora.getNombreImpresora());
            ...
            if(!fingerprintManager.isHardwareDetected()){
                    ...
                    if (!fingerprintManager.hasEnrolledFingerprints()) {
                        ...
                        if (!keyguardManager.isKeyguardSecure()) {
                            ...
                            if (cipherInit()) {
                                ...
                                helper.startAuth(fingerprintManager, cryptoObject, datosComunes);
                            }
                        }
                    }
                }
                ...
                utilitario.MostrarMensaje("Error al obtener datos", FingerprintActivity.this);
            }
    }
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        Intent principal = new Intent(FingerprintActivity.this, MainActivity.class);
